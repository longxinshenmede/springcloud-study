...
public class PaymentController {
    ...
    @HystrixCommand(fallbackMethod = "selectByPrimaryKeyHandler",commandProperties = {@HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds",value = "3000")})
    ...
    public CommonResult<Payment> selectByPrimaryKeyHandler(@PathVariable("id") Long id) {
